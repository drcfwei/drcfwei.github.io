...
<div style="display: flex; align-items: stretch; width: 100%;">
    <div style="flex: 1; padding: 10px; display: flex; flex-direction: column; justify-content: center; text-align: justify; border: none;">
    ...
    <div style="flex: 1; display: flex; align-items: center; justify-content: center;">
        <img src="/images/a1.jpeg" alt="a1" style="width: 100%; height: auto; max-height: 100%; object-fit: cover;">
    </div>
</div>
